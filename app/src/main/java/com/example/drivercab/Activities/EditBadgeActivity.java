...
public class EditBadgeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(EditBadgeActivity.this);
        ...
        imgfront.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dexter.withActivity(EditBadgeActivity.this).withPermission(Manifest.permission.READ_EXTERNAL_STORAGE)
                        .withListener(new PermissionListener() {
                            @Override
                            public void onPermissionGranted(PermissionGrantedResponse response) {
                                CropImage.activity()
                                        .setGuidelines(CropImageView.Guidelines.ON)
                                        .start(EditBadgeActivity.this);
                            }

                            @Override
                            public void onPermissionDenied(PermissionDeniedResponse response) {
                                if (response.isPermanentlyDenied()) {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(EditBadgeActivity.this);
...
//                                        Log.i("mytag",response);
                                        try {
                                            ...
                                            if (status == 0) {
                                                Toast.makeText(EditBadgeActivity.this, "Unable to upload Image" + message, Toast.LENGTH_SHORT).show();
                                            } else {
                                                Toast.makeText(EditBadgeActivity.this, message, Toast.LENGTH_SHORT).show();
                                            }

                                        } catch (JSONException e) {
                                            e.printStackTrace();
                                            Toast.makeText(EditBadgeActivity.this, "Uploaded", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                    ...
                                    public void onError(ANError anError) {
                                        ...
                                        Toast.makeText(EditBadgeActivity.this, "Error loading  ", Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                });
